...
public class WalletOpenRulesActivity extends AsukaActivity {
    private Button open;
    ...
    protected void initView() {
        setContentView(R.layout.activity_open_rules);
    ...
    protected void initEvent() {
        open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(WalletOpenActivity.class, "实名认证", bundle);
                finish();
            }
        });
    }
