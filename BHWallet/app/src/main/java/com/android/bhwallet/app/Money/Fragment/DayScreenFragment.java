    ...
    protected void initEvent() {
        commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String backTime = selectedCalendar.get(Calendar.YEAR) + "-" + (selectedCalendar.get(Calendar.MONTH) + 1) + "-" + selectedCalendar.get(Calendar.DAY_OF_MONTH);
                ...
                bundle.putInt("day", selectedCalendar.get(Calendar.DAY_OF_MONTH));
