...
public final class AnimationUtils {
     ...
     * @return
     */
    public static TranslateAnimation getTranslateAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,long durationMillis, AnimationListener animationListener) {
