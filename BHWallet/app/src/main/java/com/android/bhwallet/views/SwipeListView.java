...
import com.android.bhwallet.utils.PixelUtils;
...
public class SwipeListView extends ListView {
    ...
    private boolean isStopTopThree = false;
    ...
    public SwipeListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRightViewWidth = PixelUtils.dp2px(context, 80);
    }
    ...
    public void setIsStopTopThree(boolean isStopTopThree) {
        this.isStopTopThree = isStopTopThree;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (motionPosition >= 0) {
                    int index = motionPosition - getFirstVisiblePosition();
                    View currentItemView = getChildAt(index);
                    if (motionPosition < 2) {
                        if (isStopTopThree) {
