...
import com.asuka.android.asukaandroid.http.callback.HttpRedirectHandler;
import com.asuka.android.asukaandroid.http.callback.RequestCallBack;
import com.asuka.android.asukaandroid.http.client.DefaultSSLSocketFactory;
import com.asuka.android.asukaandroid.http.client.HttpRequest;
import com.asuka.android.asukaandroid.http.client.RetryHandler;
import com.asuka.android.asukaandroid.http.client.entity.GZipDecompressingEntity;
import com.asuka.android.asukaandroid.http.exception.HttpException;
import com.asuka.android.asukaandroid.http.task.PriorityExecutor;
import com.asuka.android.asukaandroid.http.util.OtherUtils;
...
public class HttpUtils {
    ...
    public <T> HttpHandler<T> send(HttpRequest.HttpMethod method, String url, EGRequestParams params,
                                   RequestCallBack<T> callBack) {
    ...
    public ResponseStream sendSync(HttpRequest.HttpMethod method, String url, EGRequestParams params) throws HttpException {
        if (url == null) throw new IllegalArgumentException("url may not be null");
    ...
    public HttpHandler<File> download(String url, String target,
                                      EGRequestParams params, RequestCallBack<File> callback) {
        return download(HttpRequest.HttpMethod.GET, url, target, params, false, false, callback);
    }

    public HttpHandler<File> download(String url, String target,
                                      EGRequestParams params, boolean autoResume, RequestCallBack<File> callback) {
        return download(HttpRequest.HttpMethod.GET, url, target, params, autoResume, false, callback);
    }

    public HttpHandler<File> download(String url, String target,
                                      EGRequestParams params, boolean autoResume, boolean autoRename, RequestCallBack<File> callback) {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    private <T> HttpHandler<T> sendRequest(HttpRequest request, EGRequestParams params, RequestCallBack<T> callBack) {
    ...
    private ResponseStream sendSyncRequest(HttpRequest request, EGRequestParams params) throws HttpException, com.asuka.android.asukaandroid.http.exception.HttpException {
