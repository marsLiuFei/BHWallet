 ...
 */
public class AsukaToolbar extends android.support.v7.widget.Toolbar {
    ...
    public AsukaToolbar(Context context) {
        super(context);
        resolveAttribute(context, null, R.attr.toolbarStyle);
    }
    public  AsukaToolbar(Context context,@Nullable AttributeSet attrs) {
        super(context,attrs);
        resolveAttribute(context,attrs,R.attr.toolbarStyle);
    }
    public AsukaToolbar(Context context,@Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                if (getLayoutParams() instanceof LayoutParams) {
                    LogUtil.d(Toolbar.class + "is Toolbar.LayoutParams");
