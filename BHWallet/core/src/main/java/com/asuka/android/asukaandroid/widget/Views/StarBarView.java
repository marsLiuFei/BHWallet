...
public class StarBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        paint.setShader(new BitmapShader(starFillBitmap, BitmapShader.TileMode.CLAMP, BitmapShader.TileMode
                .CLAMP));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < starCount; i++) {
            starEmptyDrawable.setBounds((starDistance + starSize) * i, 0, (starDistance + starSize) * i +
                    starSize, starSize);
        ...
        if (starMark > 1) {
            ...
            if (starMark - (int) (starMark) == 0) {
                ...
                canvas.translate(starDistance + starSize, 0);
                canvas.drawRect(0, 0, starSize * (Math.round((starMark - (int) (starMark)) * 10) * 1.0f /
                        10), starSize, paint);
            }
        } else {
