package com.asuka.android.asukaandroid.widget.photo;
...
public class MovieRecorderView extends LinearLayout implements MediaRecorder.OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidth = a.getInteger(R.styleable.MovieRecorderView_movie_width, 320);// 默认320
        mHeight = a.getInteger(R.styleable.MovieRecorderView_heighth, 240);// 默认240
    ...
    private void createRecordDir() {
        ...
        try {
            ...
            LogUtil.i(mVecordFile.getAbsolutePath());
        } catch (IOException e) {
        }
    }
    ...
    private boolean initRecord() throws IOException {
        ...
        try {
            ...
            ((AsukaActivity)context).showWarning("无法获取录音权限，请检查是否打开录音权限！");
            freeCameraResource();
