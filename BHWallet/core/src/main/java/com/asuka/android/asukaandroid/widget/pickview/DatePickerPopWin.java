package com.asuka.android.asukaandroid.widget.pickview;
...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    public static class Builder {
        ...
        private Boolean isHasFuture;
        private int maxYear;

        public Builder(Context context, OnDatePickedListener listener, Boolean isHasFuture) {
            this.context = context;
            this.listener = listener;
            this.isHasFuture = isHasFuture;
            maxYear = isHasFuture ? Calendar.getInstance().get(Calendar.YEAR) + 100 : Calendar.getInstance().get(Calendar.YEAR) + 1;
        }
